...
find the series notation of the $\arctan$ function and Viète was one 
of the first mathematicians to use an infinite series in calculation.
...
of Archimedes' method, but differs in that it consists of finding 
the area of a polygon of $n$ sides in a circle of constant 
...
Which through the trigonometric identity $\sin{2 \alpha} = 2\sin{\alpha} \cos{\alpha}$ can 
be simplified to:
...
value of $R$ being constant in this case, and since the area of a circle is defined 
...
There is however, a neater expression for this same formula. 
To simplify to it, firstly we let $U_{0} = \cos{\alpha}$. Then, we 
define $U_{1} = cos{\frac{\alpha}{2}}$, following the formula stated 
before. 
