...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
        ...
        \draw[xshift=-1cm, dotted] (1,-0.7) node[circle,fill,inner sep=1pt](a){} -- (5,-0.7) 
node[circle,fill,inner sep=1pt,label=right:$+\frac{4}{1}$](b){};

\draw[xshift=-1cm, dotted] (3.67,-1.1) node[circle,fill,inner sep=1pt, label=left:$-\frac{4}{3}$](c){} -- (5,-1.1) 
node[circle,fill,inner sep=1pt](d){};

\draw[xshift=-1cm, dotted] (3.67,-1.5) node[circle,fill,inner sep=1pt](e){} -- (4.46,-1.5) 
node[circle,fill,inner sep=1pt, label=right:$+\frac{4}{5}$](f){};

\draw[xshift=-1cm, dotted] (3.89,-1.9) node[circle,fill,inner sep=1pt, label=left:$-\frac{4}{7}$](g){} -- (4.46,-1.9) 
node[circle,fill,inner sep=1pt](h){};

\draw[xshift=-1cm, dotted] (3.89,-2.3) node[circle,fill,inner sep=1pt](i){} -- (4.33,-2.3) 
node[circle,fill,inner sep=1pt, label=right:$+\frac{4}{9}$](j){};




\draw[->, to path={-| (\tikztotarget)}, dotted]
