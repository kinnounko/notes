...
followingly, it is true that $P = \frac{A_{n}}{A} \Leftrightarrow A = \frac{A_{n}}{P}$. Since 
the area of a circle is defined by $A = \pi R^2$, the value of $R$ being constant in this case, 
