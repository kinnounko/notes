...
where $p$ is the perimeter of the polygon and $a$ is the apothem\footnote{apothem: the segment 
from the center of a polygon to the midpoint of one of its sides, here $OH$ for the $n$-gon and 
$OH'$ for the $2n$-gon}, in this case $BD \cdot n$
and $OH$ respectively, let $A_{n}$ equal the area of
the polygon with $n$ sides (displayed in \textcolor{green}{green} in Figure 2) such that: \\
...
\footnotetext{where $\prod x$ signifies a product. Similar expression to $\sum x$ as in the product of 
the terms $x$ are calculated, as opposed to the sum}
